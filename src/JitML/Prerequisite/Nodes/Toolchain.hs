...
import JitML.Prerequisite.Nodes.Common (checkAnyExecutable, homebrewPackagePrerequisite, purePrerequisite)
...
toolchainPrerequisites =
    ...
    , ghcPrerequisite
    , cabalPrerequisite
    , homebrewPackagePrerequisite (NodeId "toolchain.protoc") "Protocol buffer compiler is installed." "protoc" "protobuf" []
    ...
    , homebrewPackagePrerequisite (NodeId "toolchain.purescript") "PureScript compiler is installed." "purs" "purescript" []
