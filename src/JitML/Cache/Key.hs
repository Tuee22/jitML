...
cacheKey kernelSpec kind substrate fingerprint =
    Hash (SHA256.hash (cacheKeyMaterial kernelSpec kind substrate fingerprint))

cacheKeyMaterial :: KernelSpec -> Kind -> Substrate -> ToolchainFingerprint -> ByteString
cacheKeyMaterial kernelSpec kind substrate fingerprint =
    ByteString.concat
