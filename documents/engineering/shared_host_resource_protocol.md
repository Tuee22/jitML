...
> **Purpose**: Define one project-neutral, daemonless target protocol that `amoebius`, `infernix`,
> `jitML`, and `hostbootstrap` independently re-derive to reserve and enforce finite host-resource
> envelopes without importing one another's implementation.
