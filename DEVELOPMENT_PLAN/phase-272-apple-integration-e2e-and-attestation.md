...
layer-training artifact, which is the same defect that reopened Phases `270` and
`271` on 2026-08-12 and which the audit did not carry through to this phase.
Sprint `264.1` makes it visible rather than silent — `layerTrainingBackendFor`
now fails closed on `apple-silicon` naming Sprint `270.1` instead of executing
...
## Sprint 272.1: Apple Integration, E2E, and Attestation [⏸️ Blocked]

**Status**: Blocked
**Blocked by**: Sprints `270.1`, `271.1`
