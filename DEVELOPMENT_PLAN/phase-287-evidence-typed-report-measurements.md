# Phase 287: Evidence-Typed Report Measurements
...
⏸️ **Blocked**. Blocked by Phase 286 (Sprint 286.1).

## Sprint 287.1: Evidence-Typed Report Measurements [⏸️ Blocked]

**Status**: Blocked
**Implementation**: `src/JitML/Test/Report.hs`, `test/unit/Main.hs`
**Blocked by**: Sprint `286.1`
...
status registry that Sprint `286.1` lands.
...
- Blocked until Sprint `286.1` lands the journal-derived status registry the
