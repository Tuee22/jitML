# Phase 238: Literal Architectures - ResNet Family
...
⏸️ **Blocked**. Blocked by Phase 237 (Sprint 237.1).

## Sprint 238.1: Literal Architectures - ResNet Family [⏸️ Blocked]
...
- Implement each residual/bottleneck row as its literal named architecture on the
  single executable Sprint `235.1` graph, including real convolution, pooling,
