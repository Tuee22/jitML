# Phase 243: Literal Architectures - Vision Transformer
...
## Sprint 243.1: Literal Architectures - Vision Transformer [⏸️ Blocked]
...
- **Closing validation**: the "dense layer labelled as convolution must be
  ...
  `jitml-negative-controls` stanza (Phase `275`,
