# Phase 237: Literal Architectures - Dense, MLP, LeNet
...
⏸️ **Blocked**. Blocked by Phase 236 (Sprint 236.1).

## Sprint 237.1: Literal Architectures - Dense, MLP, LeNet [⏸️ Blocked]
...
- Implement the Dense, deep-MLP, LeNet-5, and tabular-MLP rows as their literal
  named architectures on the single executable Sprint `235.1` graph, including
