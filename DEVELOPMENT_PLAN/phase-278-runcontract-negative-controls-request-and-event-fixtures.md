# Phase 278: RunContract Negative Controls - Request and Event Fixtures
...
## Sprint 278.1: RunContract Negative Controls - Request and Event Fixtures [⏸️ Blocked]
...
- Blocked until Sprint `276.1` binds the versioned aggregate evidence to the
