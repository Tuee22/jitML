# Phase 283: Evidence-Typed Report Measurements
...
## Sprint 283.1: Evidence-Typed Report Measurements [⏸️ Blocked]
...
status registry that Sprint `282.1` lands.
...
- Blocked until Sprint `282.1` lands the journal-derived status registry the
