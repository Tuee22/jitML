...
open chain is `268 → 272 → 275 → 277 → 279 → 280 → 281 → 284 → 287 → 288`: Phases `42`, `53`, `69`, `262`, and `263` are Done, and Phase `268` is Planned. Intervening phases remain Done on their retained non-topology surfaces. Sprint `23.1` is Done — its correct reverse-mode autodiff node
