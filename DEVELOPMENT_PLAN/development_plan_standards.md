...
admission) all closed `Done` on 2026-07-27. Phase `237` (supervised serving on the
IR) is the `Active` frontier; `238`–`239` are the remaining inserted
training/construction phases; every later phase in that chain is
