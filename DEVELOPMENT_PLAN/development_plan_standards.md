...
open chain is `265 → 266 → 267 → 268 → 269 → 270 → 271 → 272 → 275 → 277 → 279 → 280 → 281 → 284 → 287 → 288`: Phases `42`, `53`, `69`, `229`, and `262` are Done; the 2026-08-12 execution-architecture reopen returned Phases `229`, `233`, `241`, `263`, `264`, `265`, `269`, and `270` to Active and moved Phase `268` to Blocked, and Phases `229`, `7`, and `72` re-closed `Done` on 2026-08-13. Intervening phases remain Done on their retained non-topology surfaces. Sprint `23.1` is Done — its correct reverse-mode autodiff node
