...
| 269 | [Registry:2 Migration and Harbor Deprecation](phase-269-registry2-migration-and-harbor-deprecation.md) | 🔄 Active | new |
| 270 | [Real Metal Kernels](phase-270-real-metal-kernels.md) | 🔄 Active | 30.1 |
| 271 | [Metal Row Device Evidence](phase-271-metal-row-device-evidence.md) | 🔄 Active | 30.2 |
| 272 | [Apple Integration, E2E, and Attestation](phase-272-apple-integration-e2e-and-attestation.md) | ⏸️ Blocked | 30.3 |
...
`53`, and `69`. The complete current chain is `268 → 269 → 270 → 271 → 272 → 273 → 276 → 278 → 280 → 281 → 282 → 285 → 288 → 289`.
The Phase `19`–`34` product-sprint checkpoint is
therefore **56 Done / 4 Active / 0 Planned / 10 Blocked** after the 2026-08-12
execution-architecture reopen, the 2026-08-13 closures of Phases `229`,
`7`, and `72`, and the 2026-08-14 closures of Phases `77`, `78`, `79`, `80`, and `84`;
Phase `266` is the first executable owner, inside the registry range. The apple-silicon wall at Phase `273`
